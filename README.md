...
<p>This is a mini WebAPI application for booking rooms.<p/>
<ul>
  <li>.Net 5</li>
...
<p>At first you must Login to get a token (/api/identity/token).</p>
<b>Username : </b>admin@MPED.pl<br>
<b>Password : </b>Admin1234

<br/>
<p>In Identity part ConfirmEmail, ForgotPassword and ResetPassword doesnt work. because I don't setup SMTP for email. By default, every user registration has email confirmation.</p>
