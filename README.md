...
<p>At the first you should Login in to get a token (/api/identity/token).</p>
<b>Username : </b>admin@MPED.pl<br>
<b>Password : </b>Admin1234

<br/>
<p>In Identity part ConfirmEmail, ForgotPassword and ResetPassword doesnt work. because I dont set SMPT for eamil. By default every user register has email confirm at the first.</p>
